...
class SystemIntegrationTest(unittest.TestCase):
    ...
    def test_integration_ADT_A01(self):
        ...
        if preprocessed_message is not None:
            has_aki = int(inference(LSTMModel(), preprocessed_message))
        communicator.acknowledge()
        communicator.close()
    ...
    def test_integration_ORU_R01_has_aki(self):
        communicator = Communicator("localhost", TEST_MLLP_PORT, TEST_PAGER_PORT)
        dataparser = DataParser()
        database = Database()
        preprocessor = Preprocessor(database)
    ...
    # def test_integration_ORU_R01_no_aki(self):
    #     pass

    # def test_integration_ADT_A03(self):
    #     pass
